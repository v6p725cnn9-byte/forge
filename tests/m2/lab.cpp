...
bool PbrHelmetLab::setup(rhi::Host& host, Camera& camera)
{
...
rhi::FrameResult PbrHelmetLab::draw(rhi::Host& host, rhi::Command& command, SDL_GPUTexture* swapchain,
...
void PbrHelmetLab::teardown(rhi::Host& host)
{
