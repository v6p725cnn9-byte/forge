...
bool SkinVehicleLab::setup(rhi::Host& host, [[maybe_unused]] render::Renderer& renderer, Camera& camera)
{
...
void SkinVehicleLab::teardown(rhi::Host& host, [[maybe_unused]] render::Renderer& renderer)
{
