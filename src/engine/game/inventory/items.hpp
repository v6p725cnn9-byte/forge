...
enum class Result : std::uint8_t {
    None, Ok, Missing, Full, NeedAxe, NeedPickaxe, Broken, TooFar, NeedStation, Invalid, Cooldown, NeedCargo
};
...
inline const char* result_text(Result result, bool en) {
    ...
    case Result::NeedCargo: return en ? "Extract needs 4 iron ingots" : "Для эвакуации нужно 4 железных слитка";
    default: return "";
    }
}
} // namespace forge::game
